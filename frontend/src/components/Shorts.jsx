...
const Home = () => {
  ...
  const fetchVideoData = async () => {
    const res = await fetch('http://localhost:5000/shorts/getall');
          ...
          <SwiperSlide>
            <div className='col- w-100   mt-4 '>
              <div className="col-md-6">
                ...
                <video autoPlay controls src={'http://localhost:5000/' + vid.video} alt="" className="card-img-top vh-100 img-fluid p-3" style={{ objectFit: "cover", height: "200px", position: "relative" }} />
                <div style={{ border: "none", position: "absolute" }}>
                  <h2 className=' fw-semibold fs-5 mt-3 ms-4 ' style={{ fontFamily: "serif" }}>{vid.shortsname}</h2>
                  <p className='text-secondary ms-4' style={{ fontFamily: "cursive" }}>{vid.shortsdetail}</p>
